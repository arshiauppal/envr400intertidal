...
percent_cover_SPES <- merge(all_cover_SPES, cover_sd_SPES, by = c("year", "site_TA"))
...
cover_agg_SPES_seasonal <- aggregate_cover_data_seasonal(cover_SPES_seasonal, cover_cols = c("total_cover", "algae_cover", "invert_cover"))
cover_agg_ENVR_seasonal <- aggregate_cover_data_seasonal(cover_ENVR_seasonal, cover_cols = c("total_cover", "algae_cover", "invert_cover"))
