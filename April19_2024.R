...
# 1m quadrat data visualization and analysis - DONE
  ...
  # Density of littorine snails per TA from summer 2019-2023
    Lit_density_TA <- plot_count_SPES(quad1m_SPES, "Littorine_snails", 
  ...
  # Density of limpets per TA from summer 2019-2023
    Limpet_density_TA <- plot_count_SPES(quad1m_SPES, "Limpets", 
...
# ENVR 400 2024 visualization functions - FINISH DOCUMENTATION
  ...
  # Generate a plot of mean limpet size measurements (length and width) across the three sampled sites
    ...
    agg_sd <- aggregate(get(agg_variable) ~ modified_TA, data = df, FUN = function(x) sd(x))
...
# Transect - DONE 
  ...
  # Density of Oysters per TA
    oyster_density_ENVR <- plot_count_ENVR(transect_ENVR, "Density_of_Oysters_count", "Mean Count of Oysters",
