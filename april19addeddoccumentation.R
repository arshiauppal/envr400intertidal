...
#' 
#' @param data the dataframe that the year needs to be extracted from
#' @param date_column_name the date column name from the provided data
#'
#' @return the new dataframe with the year column added
...
#' Convert the 0 and 1 values to true and false to indicate presence and absence of species.
#' Converts the column data starting from column index start_col_index to end_col_index. 
#' 
#' @param df the provided dataframe
#' @param start_col_index the start index of the column to begin conversion on 
#' @param end_col_index the end index of the column to end conversion on
#' 
#' @return the new dataframe with the modifications specified
convert_to_logical <- function(df, start_col_index, end_col_index) {
  df <- df %>%
    #  used to indicate the start and end of columns that need to be changed to true/false
...
#' Adding the TA helps with understanding so it is not just the site numbers 
#' 
#' @param data_frame the dataframe provided 
#' 
#' @return the new dataframe with the modifications specified
...
#'
#'@param data the data column from the respective dataframe
#'
...
#' 
#' @param data_frame the provided dataframe 
#' @param column_name the column name to divide the transect from
#' 
#' @return the new dataframe with the modifications specified
...
#' @param dataframe the dataframe provided
#' @param algae_cover_col algae cover column name
#' @param inverterbrates_cover_col inverterbrates cover column name
#' @param total_cover_col total cover column name
#' 
#' @return the new dataframe with the modifications specified
...
#' Plot percent cover along the transect line 
#' 
#' @param data the provided dataframe
#' @param color_scale the color scale 
#' @param plot_title the plot title to add to plot
...
#' 
#' @param dataframe the provided dataframe
#' @param include_year logical value to include year 
#' @param include_season logical value to include season 
#' 
#' 
#' @return produces cover dataframe 
...
#' Create a dataframe for the algae percent cover and species count plot
#' 
#' @param dataframe the provided dataframe
#' @param include_year logical value to include year 
#' @param include_season logical value to include season 
#' 
#' 
#' @return produces algae_data dataframe
...
#' 
#' 
#' @return produces invertebrates_data dataframe
...
#' @param data the provided dataframe
#' @param cover_cols the cover column 
#' @param season_col the season column 
#' @param site_TA_col the site TA column 
#' @param modified_TA the modified TA column 
#' 
#' @return aggregated dataframe cover_merge
...
#' @param data the provided dataframe
#' @param percent_cover_col the percent cover col
#' @param count_col the count col 
#' @param additional_count_col the addtional count col
#' 
#' @return a list of the aggregate data 
...
#' @param data the provided dataframe
#' @param varname the variable name being plotted
#' @param plot_title the title of the visualization 
#' @param plot_yaxis the axis being plotted
...
#' @param data the provided dataframe
#' @param species_column the species column being plotted 
...
#' @param data the provided dataframe
#' @param agg_variable the variable to aggregate on
#' @param plot_title the title of the visualization 
#' @param plot_yaxis the axis being plotted
...
#' @param data the provided dataframe
#' @param count_variable the count of the variable being plotted
#' @param plot_title the title of the visualization 
#' @param scale_fill the fill colour of the species count visualization 
...
#' @param data the provided dataframe
#' @param varname the variable name being plotted
#' @param plot_varname the plot of the variable name
#' @param plot_title the title of the visualization 
...
#' 
#' @return total percent standard deviation 
...
#' Seasonal stats
#' @param data1 the data1 df
#' @param data2 the data2 df
#' @param var_name the variable name
#' 
#' @return summary of seasonility
