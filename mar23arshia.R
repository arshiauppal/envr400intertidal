...
percent_cover_400 <- function(quad0.25m_ENVR) {
  ...
  data_agg <- aggregate(cbind(Algae_percent = Adjusted_Algae_Cover, Invertebrates_percent = Adjusted_Invert_Cover) ~ Site_TA, data = quad0.25m_ENVR, FUN = mean, na.action = na.omit)
